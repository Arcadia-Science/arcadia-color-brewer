...
arcadia.pal = function(n = 3, 
  ...
  pal = switch(name, 
               ...
               Accent = setNames(c('#5088C5', '#F28360', '#3B9886', '#F7B846', '#7A77AB', '#F898AE'),
                                 c('Aegean', 'Amber', 'Seaweed', 'Canary', 'Aster', 'Rose')),
               Lighter_accents = setNames(c('#C6E7F4', '#F8C5C1', '#B5BEA4', '#F5E4BE', '#DCBFFC', '#F5CBE4'),
                                          c('Blue_sky', 'Dress', 'Sage', 'Oat', 'Periwinkle', 'Blossom'))
               Accent_expanded = setNames(c('#97CD78', '#73B5E3', '#FFB984', '#BAB0A8', '#C85152', '#8A99AD'), 
                                         c('Lime', 'Vital_blue', 'Orange', 'Chateau', 'Dragon', 'Marine_blue'))
               Lighter_accent_expanded = setNames(c('#D1EADF', '#BABEE0', '#F1E8DA', '#DAD3C7', '#DA9085', '#B6C8D4'), 
